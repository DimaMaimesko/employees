...
@section('content')
    ...
    <div class="d-flex flex-row mb-3">
        <a href="{{ route('ajaxlist.edit', $employee) }}" class="btn btn-primary mr-1">Edit</a>
        <form method="POST" action="{{ route('ajaxlist.destroy', $employee) }}" data-confirm="Do you want to delete employee {{$employee->name}}?" class="mr-1">
            @csrf
            @method('DELETE')
